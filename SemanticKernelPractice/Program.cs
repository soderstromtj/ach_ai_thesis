    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                var instructions = "Tasking: Extract Evidence from the Context for ACH\n\n1. Objective\n\nYou will review the provided document (the \"context\") and produce one consolidated list of Evidence items. This list will become the left-hand column of an Analysis of Competing Hypotheses (ACH) matrix.\n\nYour job is to identify facts and key assumptions only. You are not to discuss, compare, or evaluate hypotheses in this task.\n\nFor each Evidence item, record:\n- EvidenceID – a unique integer starting at 1 and increasing by 1\n- Type – \"Fact\" or \"Assumption\"\n- Description – a concise, neutral statement expressing a single idea\n\nAt the end of your work, you will present a clearly labeled Evidence List containing all of these items.\n\n2. What Counts as Evidence\n\nFor this task, an Evidence item is:\n- A Fact directly supported by the context or by well-established background information, or\n- A Key Assumption that you must treat as true in order to interpret the situation or connect facts.\n\nEach Evidence item must be:\n- Atomic – expresses one main idea only\n- Traceable – clearly linked to a specific part of the context, or explicitly stated as an assumption\n- Neutral – avoids wording that embeds a conclusion or favors any hypothesis\n- Balanced – includes information that could both support and challenge plausible hypotheses\n\n3. Presenting the Final Evidence List\n\nAt the end of the exercise, present all Evidence items together in a dedicated section titled \"Evidence List\".\n\nFormat each item clearly, for example:\n\n1. EvidenceID: 1\n   Type: Fact\n   Description: <concise, neutral statement of a single idea>\n\n2. EvidenceID: 2\n   Type: Assumption\n   Description: <concise, neutral statement of a single idea>\n\n3. EvidenceID: 3\n   Type: Fact\n   Description: <concise, neutral statement of a single idea>\n\nContinue numbering until all facts and key assumptions from the context have been captured and clearly articulated in the Evidence List.";
