...
(
    ...
    [step_execution_id] UNIQUEIDENTIFIER NOT NULL,              -- Links to the step execution
    [agent_configuration_id] UNIQUEIDENTIFIER NOT NULL,         -- Which agent configuration produced this
    [completion_id] NVARCHAR(100) NULL,                         -- OpenAI Completion ID
    [agent_name] NVARCHAR(50) NOT NULL,                         -- Snapshot of agent name at response time
    ...
    [input_token_count] INT NULL,                               -- Number of input tokens sent to model
    [output_token_count] INT NULL,                              -- Number of output tokens generated by model
    [content_length] INT NULL,                                  -- Character length of response content
    [content] NVARCHAR(MAX) NULL,                               -- The actual response content
    [turn_number] INT NULL,                                     -- Turn number in multi-turn conversations
